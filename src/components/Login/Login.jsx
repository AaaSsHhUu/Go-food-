    ...
    <div className='bg-green-300 p-4 h-screen grid place-items-center'>
        <div className='bg-white w-full sm:w-2/4 flex min-h-[50vh] py-4 rounded-lg flex-col items-center'>
            ...
            <div className='text-center my-4'>
                <button className='bg-green-600 text-white px-4 py-2 rounded-md hover:bg-green-500'>Login</button>
                <br />
                <Link to={"/signup"} className='text-blue-600 hover:underline text-sm' >Don't have an account? create a new one</Link>
            </div>
        </div> 
    </div>
  )
